...
const InfoCard: FC<InfoType> = ({ icon, title, description }) => {
  return (
    <div className="h-full border border-gray-400 rounded-xl p-3 cursor-pointer hover:bg-lightHover hover:border-red-500 hover:shadow-black hover:-translate-y-1 duration-300">
